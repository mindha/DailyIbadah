...
import kukila.dailyibadah.NavbarMenu.Info;
import kukila.dailyibadah.NavbarMenu.Notifikasi;
import kukila.dailyibadah.NavbarMenu.Pengaturan;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_ibadah) {
            Fragment tab1 = new Ibadah();
            changeFragment(tab1);


        } else if (id == R.id.nav_grafik) {
            Fragment tab1 = new Grafik();
            changeFragment(tab1);


        } else if (id == R.id.nav_info) {
            Fragment tab1 = new Info();
            changeFragment(tab1);


        } else if (id == R.id.nav_notifikasi) {
            Fragment tab1 = new Notifikasi();
            changeFragment(tab1);
