...
public class DateHeader extends Fragment {

    private SectionsPagerAdapter mSectionsPagerAdapter;

    View v;
    private ViewPager mViewPager;
    ArrayList<DateHeaderModel> dataModels;
...
//        getMenuInflater().inflate(R.menu.menu_date_header, menu);
//        return true;
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_date_header, container, false);
    ...
    public void dummyTanggalMasehi() {
        dataModels = new ArrayList<>();
        for (int i = 0; i < 20; i++) {
            //public DateHeaderModel(int idMasehi, int tglMasehi, String blnMasehi, String thnMasehi)
            dataModels.add(new DateHeaderModel(i,(i+1),"Januari","2014"));
        }
    }

    public void dummyTanggalHijriah() {
        dataModels = new ArrayList<>();
        for (int i = 0; i < 20; i++) {
            //public DateHeaderModel(int idMasehi, int tglMasehi, String blnMasehi, String thnMasehi)
            dataModels.add(new DateHeaderModel((i+1),"Syawal","1476"));
        }
    }
}
